...
class DataIngestion:
    ...
    #function to extract data from databases
    def initiate_data_ingestion(self):
        logging.info("Entered the data ingestion component and method ")
        try:
...
if __name__ == "__main__":
    ...
    data_transoformation.initiate_data_transformation(train_data,test_data)
